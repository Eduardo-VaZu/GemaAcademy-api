...
import { registroLogic } from './registro.logic.js';
import { prisma } from '../../../config/database.config.js';
import { emailService } from '../../../shared/services/brevo.email.service.js';

export const usuarioLogic = {
  async procesarCreacionUsuario(userData) {
    const {
      email,
      password,
  ...
  async procesarActualizacionPerfilAlumno(userId, payload) {
